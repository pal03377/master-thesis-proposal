...
As student numbers will continue to rise (especially in Computer Science courses), the number of feedbacks which tutors have to give will increase as well.
% TODO: link new approaches in the past / extensions (BA thesis, master thesis, etc.)
% TODO: Ground work might enable new innovations like GPT to be used in Athene, if the feedback suggestion generation not only supports choosing existing feedbacks, but also generating new ones.
