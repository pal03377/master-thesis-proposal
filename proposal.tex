...
% ThemisML, more general Athene API, moving feedback suggestion functionality from Artemis to Athene, ability to simply switch microservice approaches, making feedback suggestions for programming exercises available in Artemis, integrating programming feedback suggestions using Athene into the new Themis iPad app
